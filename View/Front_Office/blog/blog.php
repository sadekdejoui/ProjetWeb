...
include 'C:\xampp\htdocs\ReProjet\ProjetWeb\view\Front_Office\get_articles.php';
    ...
    <div class="row">
        ...
        if (count($articles) > 0) {
            ...
            foreach ($articles as $article) {
                ...
                echo '<a href="http://localhost/ReProjet/View/Front_Office/blog/affichage_articles.php?id=' . $article['id'] . '" class="btn btn-primary me-2">Lire la suite</a>';
