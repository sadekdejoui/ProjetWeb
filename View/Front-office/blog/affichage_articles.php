...
if (isset($article) && $article) {
    ...
    if ($commentaires) {
        ...
        foreach ($commentaires as $commentaire) {
            ...
            echo "<a href='modif_comment.php?id=" . $commentaire['id'] . "'>Modifier</a> | ";
            echo "<a href='supprimer_comment.php?id=" . $commentaire['id'] . "' onclick='return confirm(\"Êtes-vous sûr de vouloir supprimer ce commentaire ?\");'>Supprimer</a>";
            echo "</div><hr>";
        }
    } else {
