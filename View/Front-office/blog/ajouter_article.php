...
<body>
    ...
    <form id="articleForm" action="submit_article.php" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <p id="title-error" style="color: red; display: none;"></p> <!-- Message d'erreur pour le titre -->
        </div>
        <div class="mb-3">
            <label for="author" class="form-label">Nom de l'auteur</label>
            <input type="text" class="form-control" id="author" name="author">
            <p id="author-error" style="color: red; display: none;"></p> <!-- Message d'erreur pour l'auteur -->
        </div>
        <div class="mb-3">
            <label for="email" class="form-label">Adresse e-mail de l'auteur</label>
            <input type="email" class="form-control" id="email" name="email">
            <p id="email-error" style="color: red; display: none;"></p> <!-- Message d'erreur pour l'email -->
        </div>
        <div class="mb-3">
            <label for="content" class="form-label">Contenu de l'article</label>
            <textarea class="form-control" id="content" name="content" rows="6"></textarea>
            <p id="content-error" style="color: red; display: none;"></p> <!-- Message d'erreur pour le contenu -->
        </div>
        <div class="mb-3">
...
<script>
    document.getElementById('articleForm').addEventListener('submit', function(event) {
        ...
        // Vérifier l'auteur
        if (author === '') {
            document.getElementById('author-error').textContent = 'Le nom de l\'auteur est requis.';
        ...
        // Vérifier le contenu
        if (content === '') {
            document.getElementById('content-error').textContent = 'Le contenu de l\'article est requis.';
