    ...
    <!-- Navbar End -->
        ...
        <div class="container py-5">
            ...
            <div class="row">
                ...
                include 'C:\xampp\htdocs\Projet Web - Copie 1\View\Front-office\get_articles.php';
                ...
                if (count($articles) > 0) {
                    ...
                    foreach ($articles as $article) {
                        ...
                        echo '<div class="card">';
                        echo '<img class="card-img-top" src="img/default.jpg" alt="Blog Image">';
                        ...
                        echo '<a href="http://localhost/Projet%20Web%20-%20Copie%201/View/Front-office/blog/affichage_articles.php?id=' . $article['id'] . '" class="btn btn-primary">Lire la suite</a>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                    }
