            ...
            <div class="row">
                ...
                if (count($articles) > 0) {
                    ...
                    foreach ($articles as $article) {
                        ...
                        echo '<a href="http://localhost/Projet%20Web%20-%20Copie%201%20-%20Copie/View/Front-office/blog/affichage_articles.php?id=' . $article['id'] . '" class="btn btn-primary">Lire la suite</a>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                    }
