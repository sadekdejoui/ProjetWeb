...
require_once 'C:\xampp\htdocs\ReProjet\ProjetWeb\controller\ArticleC.php';  // Inclure la classe articleC
require_once 'C:\xampp\htdocs\ReProjet\ProjetWeb\controller\CommentaireC.php';  // Inclure la classe articleC
 ...
 <div class="view-all-articles">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="http://localhost/ReProjet/View/Front_Office/blog/affichage_articles.php?id=<?php echo htmlspecialchars($commentaire['article_id']); ?>"><?php echo htmlspecialchars($commentaire['article_titre']); ?></a></td>            <td>
