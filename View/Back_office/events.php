...
try {
    ...
    $query1 = "
        SELECT 
            ...
            i.id_evenement AS event_id
        FROM 
            inscription i
        INNER JOIN 
            evénements e ON i.id_evenement = e.id_evenement
        INNER JOIN 
            utilisateurs u ON i.id_user = u.id_user
    ";
...
<head>
    ...
    <!-- educate icon CSS
		============================================ -->
    <link rel="stylesheet" href="educate-custon-icon.css">
    <!-- morrisjs CSS
		============================================ -->
    ...
    <link rel="stylesheet" href="metisMenu/metisMenu-vertical.css">
    <!-- calendar CSS
		============================================ -->
...
<body>
            ...
            <div class="header-top-area">
                <div class="container-fluid">
                    ...
                    <style>
                                            ...
                                            .col-lg-6.col-md-7.col-sm-6.col-xs-12 a {
    ...
    <button type="button" class="btn btn-primary" onclick="window.location.href='add_event.html'">Add Event</button><button type="submit">Filter</button>
</form>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="delete_registration.php" style="margin: 0;">
                            <input type="hidden" name="id_evenement" value="<?php echo htmlspecialchars($registration['event_id']); ?>">
                            <input type="hidden" name="id_user" value="<?php echo htmlspecialchars($registration['user_id']); ?>">
                            <button type="submit" class="delete-btn">Supprimer</button>
                        </form>
                    </td>
                </tr>
...
<div class="event-buttons" style="padding: 20px; text-align: center;">
    ...
    <button type="button" class="btn btn-primary" onclick="window.location.href='invite.html'">inviter</button><button type="submit"  style="background-color:#9465d4; color: white;">Search</button>
    </div>
