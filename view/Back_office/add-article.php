<?php
include 'C:\xampp\htdocs\Projet Web\config.php'; // Inclure la configuration de la base de données
...
<meta charset="utf-8">
    ...
    <style>
        ...
        input[type="reset"]:hover {
            background-color: rgb(163, 119, 234);
        }
        .error {
            color: red;
    ...
    <script>
        function validateForm() {
            ...
            if (titre.length < 3) {
                document.getElementById("titre-error").textContent = "Le titre doit contenir au moins 3 lettres.";
            ...
            if (contenu.length < 100) {
                document.getElementById("contenu-error").textContent = "Le contenu doit contenir au moins 100 lettres.";
            ...
            if (auteur.length < 3) {
                document.getElementById("auteur-error").textContent = "L'auteur doit contenir au moins 3 lettres.";
                                ...
                                <ul class="mobile-menu-nav">
                                    ...
                                    <li><a data-toggle="collapse" data-target="#demopro" href="#">Étudiants <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="demopro" class="collapse dropdown-header-top">
                                            ...
                                            <li><a href="add-student.php">Ajouter un Étudiant</a></li>
