    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="..\Back_office\index2.php"><img class="main-logo" src="..\Back_office\img\logo\logo.png" alt="" /></a>
                <strong><a href="..\Back_office\index2.php"><img src="..\Back_office\img\logo\logosn.png" alt="" /></a></strong>
            </div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="..\Back_office\index2.php"><span class="mini-sub-pro">Dashboard</span></a></li>
