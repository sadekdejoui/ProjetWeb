    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index2.php"><img class="main-logo" src="img/logo/logo.png" alt="" /></a>
                <strong><a href="index2.php"><img src="img/logo/logosn.png" alt="" /></a></strong>
            </div>
    ...
    <p><?php echo $notf['contenu']; ?></p>
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="..\Front-office\login.html"><span class="edu-icon edu-user-rounded author-log-ic"></span>Se déconnecter</a>
                                                        </li>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="index2.php">Home<span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="index2.php">Home</a> <span class="bread-slash">/</span>
                                            </li>
