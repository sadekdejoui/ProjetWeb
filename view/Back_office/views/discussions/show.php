    ...
    <ul>
        <?php foreach ($reponses as $reponse): ?>
            <li>
                ...
                <a href="index3.php?action=editReponse&id=<?= $reponse['id_reponse']; ?>&id_thread=<?= $discussion['id_thread']; ?>">Modifier</a>
                <a href="index3.php?action=deleteReponse&id=<?= $reponse['id_reponse']; ?>&id_thread=<?= $discussion['id_thread']; ?>" 
