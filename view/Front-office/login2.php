                                ...
                                <div class="card-3d-wrapper">
                                    <div class="card-front">
                                        <div class="center-wrap">
                                            ...
                                            <form action="login3.php" method="POST" class="" >
                                                ...
                                                <form action="sms.php" method="POST" class="" >
                                                    
                                                   
                                                    <button class="btn mt-4" type="submit">Envoyer Sur Sms</button>
                                                ...
                                                <form action="mail.php" method="POST" class="" >
                                                    ...
                                                    <button class="btn mt-4" type="submit">Envoyer Sur Email</button>
