...
//require('C:\xampp\htdocs\akrem web\View\Front-office\fpdf.php\fpdf186\fpdf.php');
...
$dbname = "questerra";  // Nom de votre base de données
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $questionsQuery = "SELECT id, correct_answer FROM questions5";
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        <a href="../Front-office/index.php" class="nav-item nav-link">Home</a>
                        <a href="..\Front-office\blog.php" class="nav-item nav-link ">Blog</a>
                        <a href="../Front-office/Cours.html" class="nav-item nav-link active">Courses</a>
                       <a href="c:\Users\21628\Downloads\wetransfer_projet-web_2024-11-18_2122\Projet Web\view\Front-office\les taches\firas\ecahnge.html" class="nav-item nav-link">Questions</a>
                        <a href="event.php" class="nav-item nav-link">Events</a>
                        <a href="c:\Users\21628\Downloads\wetransfer_projet-web_2024-11-18_2122\Projet Web\view\Front-office\les taches\maram\contact.php" class="nav-item nav-link">Complaints</a>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                          <a href="c:\Users\21628\Downloads\wetransfer_projet-web_2024-11-18_2122\Projet Web\view\Front-office\les taches\sadek\account.html">Mon compte</a>
                          <a href="c:\Users\21628\Downloads\wetransfer_projet-web_2024-11-18_2122\Projet Web\view\Front-office\les taches\sadek\index.php">Se déconnecter</a>
                        </div>
                      </div>
            </nav>
...
<?php else: ?>
    <form method="POST" action="">
        ...
        <?php
        // Récupérer les questions depuis la base de données (table questions5)
        $questions1Query = "SELECT id, question_text FROM questions5";
    ...
    <div class="container py-5 px-lg-5">
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <a class="btn btn-link" href="c:\Users\21628\Downloads\wetransfer_projet-web_2024-11-18_2122\Projet Web\view\Front-office\les taches\imen\blog.php">Blog</a>
                ...
                <a class="btn btn-link" href="event.php">Evénement</a>
                <a class="btn btn-link" href="c:\Users\21628\Downloads\wetransfer_projet-web_2024-11-18_2122\Projet Web\view\Front-office\les taches\maram\contact.php" class="nav-item nav-link">Complaint</a>
            </div>
            <div class="col-md-6 col-lg-3">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-end">
                    <div class="footer-menu">
                        <a href="c:\Users\21628\Downloads\wetransfer_projet-web_2024-11-18_2122\Projet Web\view\Front-office\index.php">Accueille</a>
                    </div>
                </div>
            </div>
        </div>
