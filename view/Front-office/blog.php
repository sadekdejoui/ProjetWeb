...
include '../../view/Front-office/get_articles.php'; 
    ...
    <div class="row">
        ...
        if (count($articles) > 0) {
            ...
            foreach ($articles as $article) {
                ...
                echo '<a href="http://localhost/Projet%20Web/View/Front-office/affichage_articles.php?id=' . $article['id'] . '" class="btn btn-primary me-2">Lire la suite</a>';
...
<style>
    ...
    border: 2px solid #ac81f2; /* Bordure verte */
...
.pdf-container a {
    ...
    background-color: #ac81f2; /* Couleur de fond verte */
...
.pdf-container a:hover {
    background-color: rgb(163, 119, 234); /* Couleur de fond au survol */
}
</style>
