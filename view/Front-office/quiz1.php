...
//require('C:\xampp\htdocs\ReProjet\testtest\view\Front-office\fpdf.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $questionsQuery = "SELECT id, correct_answer FROM questions1";
...
<?php else: ?>
    <form method="POST" action="">
        ...
        $questions1Query = "SELECT id, question_text FROM questions1";
