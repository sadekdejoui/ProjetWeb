            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        <a href="..\Front-office\index.php" class="nav-item nav-link active">Home</a>
                        <a href="..\Front-office\login.html" class="nav-item nav-link ">Blog</a>
                        <a href="..\Front-office\login.html" class="nav-item nav-link">Courses</a>
                        <a href="..\Front-office\login.html" class="nav-item nav-link">Questions</a>
                        <a href="..\Front-office\login.html" class="nav-item nav-link">Events</a>
                        <a href="login.html" class="nav-item nav-link ">Complaints</a>
                ...
                <div class="container px-lg-5">
                    <div class="row g-5 align-items-end">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <a href="..\Front-office\login.html" class="btn btn-secondary py-sm-3 px-sm-5 rounded-pill me-3 animated slideInLeft">See More</a>
...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
           ...
           <!-- <a href="../Front-office/les taches/maram/contact.php" class="btn btn-custom py-2 px-4 ms-3 d-none d-lg-block">Faire une réclamation</a>-->
        </div>
    </div>
</div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <a class="btn btn-link" href="..\Front-office\login.html">Blog</a>
                        <a class="btn btn-link" href="..\Front-office\login.html">    Cours</a>
                        <a class="btn btn-link" href="..\Front-office\login.html">Questions</a>
                        <a class="btn btn-link" href="..\Front-office\login.html">Evénement</a>
