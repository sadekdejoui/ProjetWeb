                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Forums" href="index.php?action=index"><span class="mini-sub-pro">Tous les forums</span></a></li>
                                <li><a title="Create Forum" href="index.php?action=create"><span class="mini-sub-pro">Créer un forum</span></a></li>
                                <li><a title="Create Forum" href="index.php?action=indexr"><span class="mini-sub-pro">tous les reponses</span></a></li>
                            </ul>
                        </li>
                        <li>
